...
import { AppRegistry, StyleSheet, BackHandler, StatusBar, View } from 'react-native'
import { Navigator } from 'react-native-deprecated-custom-components'
import HomePage from './jscore/HomePage'

class RN_gank extends Component {
    constructor (props) {
        super(props);
...
AppRegistry.registerComponent('RN_gank', () => RN_gank);
